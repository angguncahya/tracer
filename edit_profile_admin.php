...
<?php 	
	...
	if($_POST){
				...
				if(empty($tanggal)){
					$update = "UPDATE file_pengguna SET email='$email', tempat_lhr='$tempat_lahir'";
				}else{
					$update = "UPDATE file_pengguna SET email='$email', tempat_lhr='$tempat_lahir', tgl_lhr='$tanggal_lahir' ";
				}
...
<div class="row" id="content_about">
	<div class="container">
		...
		<!-- 	<div class="form-group">
			...
			<div class="form-group">
				<label for="username" class="col-sm-2 control-label" style="text-align:left;"> Nama Admin </label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="username" id="username" value="<?php echo $user['nama'];?>" >
				</div>
			</div>
			<div class="form-group">
