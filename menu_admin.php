	...
	<nav class="navbar navbar-inverse" id="menu_home" role="navigation">	
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right" style="font-size: 18px;">
				...
				<li><a href="confirm_registration.php"> CONFIRM <span class="sr-only">(current)</span></a></li>
				<li><a href="member_list.php"> LIST ALUMNI <span class="sr-only">(current)</span></a></li>
					<li class="dropdown">	
