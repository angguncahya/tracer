			...
			<footer class="bs-docs-footer" role="contentinfo">
			  <div class="container">
					<p class="navbar-text">
						<h5 align="center" id="footer">
							Desain belum final kok © 2017<a href="#" class="navbar-link"></a>
						</h5>
					</p>
			  </div>
			</footer>
		...
		<script type="text/javascript">
			...
			$('#tanggal_masuk .input-group.date').datepicker({
				format: 'yyyy-mm-dd',
				todayBtn: true,
				language: 'id',
				todayHighlight: true,
			...
			$('#tanggal_lulus .input-group.date').datepicker({
				format: 'yyyy-mm-dd',
				todayBtn: true,
				language: 'id',
				todayHighlight: true,
			...
			$('#tanggal_mulai_kerja .input-group.date').datepicker({
				format: 'yyyy-mm-dd',
				todayBtn: true,
				language: 'id',
				todayHighlight: true,
